...
cmd_prefix = 'cd ../gem5; build/X86/gem5.opt configs/example/se.py --bp-type={} --cmd=../test_programs/{} --mem-size={} --input=../test_programs/{} --output=../../test_programs/{}'

table = [[0]*4,[0]*4,[0]*4,[0]*4]
table[1][0] = 'perceptron' 
table[2][0] = 'path-based perceptron'
table[3][0] = 'piecewise perceptron'
...
for i in range(len(bps)):
	...
	for j in range(len(cmd_args)):
		...
		table[i+1][j+1] = (accuracy, num_total, num_misses)
